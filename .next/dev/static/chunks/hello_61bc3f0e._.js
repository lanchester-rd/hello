...
function TimelinePreviewPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$hello$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TimelinePreviewPage.useEffect": ()=>{
            const key = ("TURBOPACK compile-time truthy", 1) ? sessionStorage.getItem("timeline-admin-key") || "" : "TURBOPACK unreachable";
            fetch("/api/timeline/events?admin=true", {
                headers: {
                    "x-admin-key": key
                }
            }).then({
                "TimelinePreviewPage.useEffect": (r)=>r.json()
            }["TimelinePreviewPage.useEffect"]).then({
                "TimelinePreviewPage.useEffect": (data)=>{
                    setEvents(data);
                    setLoading(false);
                }
            }["TimelinePreviewPage.useEffect"]).catch({
                "TimelinePreviewPage.useEffect": ()=>setLoading(false)
            }["TimelinePreviewPage.useEffect"]);
        }
    }["TimelinePreviewPage.useEffect"], []);
...
//# sourceMappingURL=hello_61bc3f0e._.js.map