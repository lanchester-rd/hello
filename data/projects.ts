...
export const projects: Project[] = [
  {
    ...
    complexityTags: ['Regulatory', 'Traceability', 'Behavioral Design', 'NVC', 'Conversational AI'],
    industry: 'Legal / Dispute Resolution',
    scaleStage: 'Regulated',
    metrics: [
      { label: 'Ecosystem Scope', value: 'App + WhatsApp layer covering co-parenting coordination, NVC guidance and court-ready documentation' },
      { label: 'System Complexity', value: 'Message parsing, NVC reframing engine, calendar extraction, structured audit logs and community integrations' },
      { label: 'Operational Impact', value: 'Defensible interaction records generated passively; reduces conflict recurrence and administration overhead' }
    ]
  },
...

  {
    ...
    complexityTags: ['Regulatory', 'Traceability', 'Audit Trail', 'Structured Reporting'],
    industry: 'Legal / Compliance / Operations',
    scaleStage: 'Growth',
    metrics: [
      { label: 'Product Scope', value: 'Timestamped evidence capture, structured export formats and defensible audit trails' },
      { label: 'System Complexity', value: 'Immutable log architecture with jurisdiction-aware export and chain-of-custody metadata' },
      { label: 'Operational Impact', value: 'Reduces manual documentation overhead and strengthens evidentiary defensibility' }
    ]
  },
...

  {
    ...
    complexityTags: ['Consumer Social', 'Health Tracking', 'Real-Time Sync', 'Shelter Operations'],
    industry: 'Pet Care / Animal Welfare',
    scaleStage: 'Early',
    metrics: [
      { label: 'Ecosystem Scope', value: 'Mobile app (caregivers) + shelter web dashboard with real-time foster update relay' },
      { label: 'System Complexity', value: 'Health logs, training tracker, pack/social structures and live sync to shelter coordinators' },
      { label: 'Operational Impact', value: 'Reduces manual check-ins and gives shelters live visibility into distributed foster placements' }
    ]
  },
