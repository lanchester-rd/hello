...
export const projects: Project[] = [
  {
    ...
    complexityTags: ['Regulatory', 'Traceability', 'Behavioral Design', 'NVC'],
    ...
    metrics: [
      ...
      { label: 'System Complexity', value: 'NVC-guided communication, calendar extraction, and court-ready documentation' },
      { label: 'Operational Impact', value: 'Structured co-parenting coordination integrated with local community ecosystems' }
    ]
  },

  {
    ...
    complexityTags: ['Regulatory', 'Traceability', 'NLP', 'Conversational AI'],
    industry: 'Legal / Dispute Resolution',
    scaleStage: 'Regulated',
    metrics: [
      { label: 'Channel Scope', value: 'WhatsApp as the primary mediation surface with zero-friction adoption' },
      { label: 'System Complexity', value: 'Message parsing, NVC reframing engine, calendar extraction and structured audit logs' },
      { label: 'Operational Impact', value: 'Court-admissible interaction logs generated passively from natural conversation' }
    ]
  },
...

  {
    ...
    complexityTags: ['Multi-Market', 'Logistics', 'Personnel Management', 'Regulatory'],
    industry: 'Logistics / Aviation',
    scaleStage: 'Growth',
    metrics: [
      { label: 'Market Scope', value: 'Cross-border package and personnel coordination across international routes' },
      { label: 'System Complexity', value: 'Customs compliance, package tracking and crew assignment workflows' },
      { label: 'Operational Impact', value: 'Reduced manual coordination overhead for onboard courier operations' }
    ]
  },

  {
    ...
    complexityTags: ['Consumer Social', 'Behavioral Design', 'Matching'],
    industry: 'Events / Social',
    scaleStage: 'Early',
    metrics: [
      { label: 'Concept Scope', value: 'Event-based social discovery — connecting people through shared cultural experiences' },
      { label: 'System Complexity', value: 'Ticket posting, match-making and trust flows for strangers meeting at events' },
      { label: 'User Insight', value: 'Reduces entry friction for solo attendees while filling otherwise wasted seats' }
    ]
  },

  {
    ...
    complexityTags: ['Consumer Social', 'Conversation Design', 'Branching UX'],
    industry: 'Messaging / Social',
    scaleStage: 'Early',
    metrics: [
      { label: 'Concept Scope', value: 'Branching thread model anchored to specific message segments' },
      { label: 'System Complexity', value: 'Non-linear conversation graph with contextual highlight states' },
      { label: 'User Insight', value: 'Reduces derailment in group discussions by preserving context per thread' }
    ]
  },

  {
    ...
    complexityTags: ['Consumer Social', 'Health Tracking', 'Community Infrastructure'],
    industry: 'Pet Care / Consumer',
    scaleStage: 'Early',
    metrics: [
      { label: 'Product Scope', value: 'Routines, health logs, training tracker and social sharing for dog owners and fosters' },
      { label: 'System Complexity', value: 'Foster network syncing, care handoff flows and health history portability' },
      { label: 'User Insight', value: 'Bridges casual pet owners and shelter foster carers in a shared care ecosystem' }
    ]
  },

  {
    ...
    complexityTags: ['Community Infrastructure', 'Food Systems', 'Circular Economy'],
    industry: 'Food / Community',
    scaleStage: 'Early',
    metrics: [
      { label: 'Mission Scope', value: 'Surplus food redistribution coordinated through community kitchen networks' },
      { label: 'System Complexity', value: 'Supply matching, contributor onboarding and local distribution flows' },
      { label: 'Operational Impact', value: 'Measurable reduction in food waste through structured community coordination' }
    ]
  },

  {
    ...
    complexityTags: ['AI-Enabled', 'Computer Vision', 'Consumer Commerce'],
    industry: 'Consumer / Resale',
    scaleStage: 'Early',
    metrics: [
      { label: 'Product Scope', value: 'Photo-based item identification, valuation and resale channel recommendations' },
      { label: 'System Complexity', value: 'Computer vision pipeline, pricing models and marketplace integrations' },
      { label: 'User Insight', value: 'Dramatically lowers the effort barrier for converting clutter into cash' }
    ]
  },

  {
    ...
    cover: '/images/portfolio/fluffybutt/fluffybutt_cover.webp',
    hero: '/images/portfolio/fluffybutt/fluffybutt_hero.webp',
    complexityTags: ['Real-Time Sync', 'Shelter Operations', 'Foster Management'],
    industry: 'Animal Welfare / Non-profit',
    scaleStage: 'Early',
    metrics: [
      { label: 'Product Scope', value: 'Live dashboard for shelter staff to track foster dog health, routines and milestones' },
      { label: 'System Complexity', value: 'Real-time sync between app (foster carer) and web (shelter coordinator)' },
      { label: 'Operational Impact', value: 'Reduces check-in overhead and gives shelters confidence in foster placements' }
    ]
  },

  {
    ...
    complexityTags: ['Consumer Utility', 'Widget UX', 'Family Tech'],
    industry: 'Family / Consumer',
    scaleStage: 'Early',
    metrics: [
      { label: 'Product Scope', value: 'Glanceable availability widget for real-time babysitting coordination' },
      { label: 'System Complexity', value: 'Calendar sync, availability state and low-friction family sharing' },
      { label: 'User Insight', value: 'Eliminates coordination overhead for informal childcare arrangements' }
    ]
  }
  ...
  ,
  {
    ...
    complexityTags: ['AI-Augmented', 'Hospitality', 'Real-Time Context'],
    industry: 'Hospitality / Hotel Tech',
    scaleStage: 'Early',
    metrics: [
      { label: 'Product Scope', value: 'Real-time guest intelligence surfaced to hotel staff at point of interaction' },
      { label: 'System Complexity', value: 'Guest preference modeling, PMS integration and staff-facing contextual UI' },
      { label: 'Operational Impact', value: 'Enables consistent, personalised service delivery without manual briefing overhead' }
    ]
  }
]
